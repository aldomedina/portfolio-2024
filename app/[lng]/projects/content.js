const featuredProjects = [
  {
    ...
    images: {
      ...
      carousel: [
        { id: 'wargames1', image: '/img/wargames1.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'wargames2', image: '/img/wargames2.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'wargames3', image: '/img/wargames3.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'wargames4', image: '/img/wargames4.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'wargames5', image: '/img/wargames5.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'wargames6', image: '/img/wargames6.webp', scale: [2.4, 2.4, 0.01] },
      ],
      final: { type: 'image', url: '/img/wargames-fallback.webp', width: 1536, height: 818 },
    },
    blurDataUrl:
  ...
  },
  {
    ...
    links: [
      {
        tag: 'DEMO',
        url: 'https://alumni-data-vis.vercel.app/',
      },
    ],
    images: {
      featured: { type: 'image', url: '/img/ui-opened.webp', width: 4536, height: 2946 },
      carousel: [],
      final: { type: 'image', url: '/img/ui-closed.webp', width: 4536, height: 2946 },
    },
    blurDataUrl:
  ...
  },
  {
    ...
    links: [
      {
        tag: 'PROJECT WEBITE',
        url: 'https://solids.live',
      },
      {
        tag: 'OPENSEA',
        url: 'https://opensea.io/collection/solids-by-far',
      },
    ],
    images: {
  ...
  },
  {
    ...
    links: [''],
    images: {
      featured: { type: 'video', url: '/videos/teapotfeatured.mp4' },
      carousel: [
        { id: 'teapot1', image: '/img/teapot1.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'teapot2', image: '/img/teapot2.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'teapot3', image: '/img/teapot3.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'teapot4', image: '/img/teapot4.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'teapot5', image: '/img/teapot5.webp', scale: [2.4, 2.4, 0.01] },
        { id: 'teapot6', image: '/img/teapot6.webp', scale: [2.4, 2.4, 0.01] },
      ],
      final: { type: 'image', url: '/img/finalteapot.webp', width: 1728, height: 864 },
    },
    blurDataUrl:
